...
- Highlight this is specific to HTML (not JSON, for example)
- `lang` works on all (most) elements
- Link to I18n?
- What happens if I18n != english? Or, the opposite? If we set html lanf to
  "fr"?
- Note that this is for application defined text. user defined text 
- https://github.com/rails/rails/pull/42404#issuecomment-860205183

New Rails apps do not set a `lang` attribute. This is be design.
If you want to do this, you can leverage `I18n`, or set the value manaully
