...
class TaggedLoggingTest < ActiveSupport::TestCase
  ...
  setup do
    @logger = ActiveSupport::TaggedLogging.new(MyLogger.new($stdout))
  end
  ...
  test "tagged once with blank and nil" do
    assert_logged "[New] Funky time\n", @logger do
      @logger.tagged(nil, "", "New") { @logger.info "Funky time" }
    end
  end

  test "keeps each tag in their own thread" do
    assert_logged "Dull story\n[OMG] Cool story\n[BCX] Funky time\n", @logger do
